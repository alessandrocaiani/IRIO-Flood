runModel<-function(IO,IO_noCons,measures,coefficienti_consumo,params,rounds,LD,ExpService,ExpSectoral,epsilon,mobility){
...
#  parameters[,"c_b"]=as.numeric(params[nSectors+5])
  ...
  #GDPloss=1-sum(GDP)/(GDP[1]*53)
  GDPLoss=1-sum(GDP)/(GDP[1]*80)

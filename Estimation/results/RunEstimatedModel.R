#THIS SCRIPT ALLOWS TO SIMULATE THE MODEL ON THE COVID-19 TIMESPAN AND TO GENERATE THE DATA REQUIRED FOR THE PLOTS RELATED TO THE ESTIMATION PHASE
library(matrixStats)
library(readxl)
library(readr)
nstats=26
...
MSMresults <- readRDS("MSM_REV1_DiffCons_EXP.rds") #for revised Leontief
#MSMresults = readRDS("MSM_REV1_DiffCons_EXP_TradL.rds") #for traditional Leontief
...
TradLeontief=0 #0 for modified Leontief, 1 for traditional Leontief
...
# one 6 is "number of quarters"; the other 4 is "services whose data on revenues are available"
...
lossExpenditure=(sum(expenditure_q_3)-600)/600
...
save.image("Workspace_EST_ModifiedLeontief.Rdata")
#save.image("Workspace_EST_TraditionalLeontief.Rdata")

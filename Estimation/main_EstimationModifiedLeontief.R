#This is for the estimation of the model with the revised Leontief p.f.
...
#fits<-foreach(j=1:nrow(Sample)) %do% {
  ...
  nstats=26
  nbRounds=80
  source("ModelEstimationModifiedLeontief.R")
...
saveRDS(fit,file = "results/MSM_REV1_DiffCons_EXP_unrstr.rds")
